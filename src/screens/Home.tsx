...
import { ScanLine, ImageUp, HelpCircle, ShieldCheck, ArrowRight } from 'lucide-react'
const mediscanLogo = '/mediscan_logo.png'
    ...
    <div className="min-h-full bg-neutral-50 flex flex-col">
      ...
      <div className="bg-white border-b border-neutral-200 px-5 pt-3 pb-4 flex items-center justify-between">
        <div className="flex items-center">
          <img src={mediscanLogo} alt="MediScan" className="h-8 w-auto" />
        </div>
        <button
